        ...
        return(
            <div id = "About">
                <Wrapper className = "About" background_color = "#212F3C">
                    ...
                    <ParagraphContainer>
                        <Body color="#D6EAF8">My name is Scott Beinlich I am a 2nd-year computer science engineering student at the University of Michigan. I live in Ann Arbor,  and I was born in and grew up in Dayton, Ohio. In addition to my CS course load, I spend a lot of a time  on personal projects, team projects, and learning/practicing new CS concepts.</Body>
                        ...
                        <Body color="#D6EAF8">As for hobbies…</Body>
                    </ParagraphContainer>
                    
                    <AdventurePic src = {lakeChutes}/>
                    <AdventurePic src = {vailSitting}/>
                    <ParagraphContainer>
                        <Body color="#D6EAF8">I love skiing and hiking in the mountains. I’m a ski-club officer in U of M’s ski club, and I love to be active and play sports, especially soccer. I’m also very into indie music, long-boarding, and cars.</Body>
